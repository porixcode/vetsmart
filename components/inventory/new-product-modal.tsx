...
import { createProduct, type InventoryActionState } from "@/lib/actions/inventory"
import {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] max-w-xl overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Agregar un producto al inventario</DialogDescription>
        </DialogHeader>
          ...
          <div className="grid grid-cols-2 gap-4">
            <FieldGroup>
              <Field>
                ...
                <Input id="code" name="code" placeholder="Ej: MED-001" required />
              </Field>
            </FieldGroup>
            <FieldGroup>
              <Field>
            ...
            <FieldGroup>
              <Field>
                ...
                <Input id="brand" name="brand" placeholder="Marca" />
              </Field>
            </FieldGroup>
            <FieldGroup>
              <Field>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <FieldGroup>
              <Field>
                ...
                <Input id="salePrice" name="salePrice" type="number" min="0" defaultValue="0" />
              </Field>
            </FieldGroup>
            <FieldGroup>
              <Field>
            ...
            <FieldGroup>
              <Field>
                ...
                <Input id="minimumStock" name="minimumStock" type="number" min="0" defaultValue="0" />
              </Field>
            </FieldGroup>
          </div>
